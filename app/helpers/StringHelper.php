...
{
	/**
	 * Funcion que protege los strings agregando 'slashes' (\)
	 * 
	 * Ejemplo:
	 * <code>
	 * $cadena = StringHelper::paranoid("this is a test'"); // Devuelve "this is a test\'"
	 * </code>
	 *
	 ...
	 * Ejemplo:
	 * <code>
	 * $cadena = StringHelper::('HolaMundo'); // Devuelve 'hola_mundo'
	 * </code>
	 *
	 * @return string Devuelve la cadena procesada
	 * @author Miguelati
