<div class="footer" style="background:#c9c9c9">
	<div class="baseWidth auto">
		<div class="w33pc left center">
			<div class="padd20">
				<img src="{{ asset('/images/logo_small.png') }}">
			</div>
		</div>
		<div class="w33pc left font12">
			<div class="height86"></div>
			<div style="margin-left:45px">
				<div>©2013 Green Capital | Schu-Alm S.A.</div>
								<div>Todos los derechos reservados. <a href="{{ route('privacidad') }}" class="color_azul_link">Políticas de privacidad</a>.</div>
							</div>
		</div>
		<div class="w33pc left center">
